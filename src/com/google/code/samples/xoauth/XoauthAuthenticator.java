...
/*
 * 
 * Classe que faz a autenticação e pega as mensagens do GMAIL
 * 
 */
...
public class XoauthAuthenticator {
  ...
  public static void main(String args[]) throws Exception {
	...
	// preencha estes campos com os dados que você conseguiu em Xoauth
    String email = "EmailqueVoceEstaTestando";
    String oauthToken = "SeuToke";
    String oauthTokenSecret = "SeuSecret";
    ...
    SearchTerm search = new AndTerm(new SubjectTerm("MAC5855-2012"), new BodyTerm("MAC5855-2012"));
    ...
    // Atividade
    Message todasMessages[] = inbox.getMessages();
    for (Message todas: todasMessages) {
    	System.out.println(todas.getSubject().toString());
    }
    
    
    System.out.println ("Total de mensagens não lidas na caixa de entrada: " + inbox.getUnreadMessageCount());
